...
if (typeof mod.chartPage !== 'function') { failures++; console.log('  FAIL chartPage export'); }
  ...
  check('render: search UI in built HTML', html.includes('id="msrchbtn"') && !html.includes('msrchrow') && html.includes('id="msrchq"') && html.includes('id="msrchres"') && !html.includes('msrchseg'));
